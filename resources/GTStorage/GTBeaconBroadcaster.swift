...
class GTBeaconBroadcaster: NSObject, CBPeripheralManagerDelegate {
    ...
    */
    ...
    func startBeacon()  -> (success: Bool, error: NSString?) {
        ...
        return startBeaconFor(_beaconConfig.getValue("UUID", fromStore:"settings") as! NSString,
            withMajor: _beaconConfig.getValue("major", fromStore:"settings") as! NSNumber,
            withMinor: _beaconConfig.getValue("minor", fromStore:"settings") as! NSNumber,
            withPower: _beaconConfig.getValue("power", fromStore:"settings") as! NSNumber)
    }
    ...
    func startBeaconFor(_ beaconName: NSString, withMajor: NSNumber, withMinor: NSNumber, withPower: NSNumber) -> (success: Bool, error: NSString?) {
        ...
        if(_peripheralManager!.state != .poweredOn) {
            ...
            if (peripheralData != nil) {
                ...
                _beaconConfig.writeValue(true as NSNumber, forKey: "broadcasting", toStore: "settings")
    ...
    */
    ...
    func stopBeacon() {
        ...
        if (_peripheralManager!.isAdvertising) {
            ...
            _beaconConfig.writeValue(false as NSNumber, forKey: "broadcasting", toStore: "settings")
    ...
    */
    ...
    func peripheralManagerDidUpdateState(_ peripheral: CBPeripheralManager) {
        ...
        if (peripheral.state == .poweredOn) {
            ...
            let shouldBroadcast: Bool = (_beaconConfig.getValue("broadcasting", fromStore: "settings") as! NSNumber).boolValue
